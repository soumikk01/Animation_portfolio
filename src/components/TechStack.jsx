        ...
        <section ref={sectionRef} id="tech-stack" className="tech-stack-premium">
            <div className="container">
                ...
                <div className="tech-map-container">
                    <svg ref={svgRef} className="connectivity-svg" viewBox="0 0 1100 1400" preserveAspectRatio="xMidYMid meet">
                        ...
                        {techData.map((cat, catIdx) => {
                            ...
                            return (
                                <div key={catIdx} className="tech-category-group">
                                    <div className="tech-node category-node" style={{ top: `${baseTop}px`, left: '30px' }}>
